...
public class FolderController {
    ...
    //
    @DeleteMapping
    public ResponseDto<?> deletePhotos(@PathVariable Long folderId,@RequestParam(value = "photoId", required = true) List<Long>photoId,@AuthenticationPrincipal UserDetailsImpl userDetails) {
